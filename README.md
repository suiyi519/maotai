...
2024/03/15
首先感谢此项目的作者把代码开源了
我是通过某论坛偶然知道这个项目,出于上班无聊的心态搞了一下.
目前修改后也是自己一个人在使用,一开始跑在docker的青龙面板上,没能跑成功
于是打算直接跑到Linux上算了,也就有了这个修改版.
由于自己是个Java后端开发,对前端js代码一知半解,不好之处请见谅.

只要有两处修改
1.cookie等环境变量通过.env文件写入
2.通知只保留pushdeer的方式,通知的方法提取到huluwa.js文件中,key是在.env文件里定义
